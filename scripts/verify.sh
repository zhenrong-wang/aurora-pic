...
PYTHONPATH=scripts python3 scripts/test_instrument_edupic_collision_enabled_common_state.py
PYTHONPATH=scripts python3 scripts/test_run_edupic_collision_enabled_common_state_ensemble.py
PYTHONPATH=scripts python3 scripts/test_analyze_edupic_collision_enabled_common_state_ensemble.py
PYTHONPATH=scripts python3 scripts/test_analyze_edupic_four_period_electron_balance.py
PYTHONPATH=scripts python3 scripts/test_run_aurorapic_corrected_phase_eedf.py
PYTHONPATH=scripts python3 scripts/test_analyze_edupic_corrected_phase_eedf.py
PYTHONPATH=scripts python3 scripts/test_run_turner_subcycle_policy_invariance.py
PYTHONPATH=scripts python3 scripts/test_run_turner_collision_opportunity.py
PYTHONPATH=scripts python3 scripts/test_analyze_edupic_common_state_divergence.py
PYTHONPATH=scripts python3 scripts/test_analyze_edupic_ion_density_refresh_control.py
PYTHONPATH=scripts python3 scripts/test_analyze_edupic_ion_density_refresh_cadence.py
