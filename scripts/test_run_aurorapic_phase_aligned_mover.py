...
from run_aurorapic_phase_aligned_mover import relaxation_deck


def main() -> int:
    rule = json.loads(Path(
        "benchmarks/ccp/edupic-phase-aligned-mover-rule-20260825.json"
...
"""
    ...
    assert "phi_left_phase = 1.5723671231216914" in deck
    ...
    print("phase-aligned mover runner tests passed")
    return 0
