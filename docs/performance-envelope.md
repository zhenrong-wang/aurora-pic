...
| `examples/hall_field_profile_smoke.cfg` | 2D3V | 16 x 8 nodes | 8 initial / 16 final | 4 | Single-thread SI smoke for a one-coordinate magnetic profile, 200 V axial drop, mixed Dirichlet-x/periodic-y topology, and bounded charge-balanced uniform-box pair injection; not a HET discharge result. |
