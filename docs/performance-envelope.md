...
| `examples/hall_field_profile_smoke.cfg` | 2D3V | 16 x 8 nodes | 8 initial / 16 final | 4 | Single-thread SI smoke for a magnetic profile, 200 V axial drop, mixed topology, eV-resolved loading, pair/cathode controls, axial species/current profiles, trapezoidal time averages, and complex azimuthal modes 0–3; not a HET discharge result. |
