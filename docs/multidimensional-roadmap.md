...
| M5 | Complete | Higher-fidelity physics | Added prescribed uniform-B Boris integration for 2D/3D electrostatic runs and tabulated 1D elastic/excitation MCC, with CTest and CLI examples; self-consistent electromagnetic fields and multidimensional/reactive collision models remain later M5 extensions. |
