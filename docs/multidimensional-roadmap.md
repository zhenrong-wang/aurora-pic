...
| M5 | Current baseline | Higher-fidelity physics | Added prescribed uniform-B Boris integration for 2D/3D electrostatic runs, with CTest and CLI examples guarding magnetic rotation and conservation; self-consistent electromagnetic fields and improved collision models remain later M5 extensions. |
